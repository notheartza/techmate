...
class NewsDatePage extends StatefulWidget {
  @override
  _NewsDatePageState createState() => _NewsDatePageState();
}

class _NewsDatePageState extends State<NewsDatePage> {
  ...
  Future<News> _NewsData(BuildContext context) async {
    ...
    var response = await http.get(
        'http://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=ddd38a270ab14301ae09e5a80f0db98f',
